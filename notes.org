...
*** 2021-01-26 Tuesday
**** Stop saying censorship if it's not the government?
    [[mu4e:msgid:c7a662c7-b3da-b2d1-a401-87b08028e2c9@craphound.com][[Plura-list] Stop saying "it's not censorship if it's not the government"; Trump's swamp gators find corporate refuge; and more!]]
***** like imagine when John Birch Society burned rock records and novels
***** or MPAA ratings
****** scope "this film is not yet rated" for good intro on this
       https://en.wikipedia.org/wiki/This_Film_Is_Not_Yet_Rated
***** but don't impose speech duties on private platforms
****** fairness doctrine leads to BBC hostsing anti vaxxers and climate deniers
****** you can't improve the judgement of tech companies
****** demanding army of moderators simply means nobody can challenge twitter google
       because nobody can afford that many moderators
***** instead
****** block mergers
****** unwind mergers
...
**** Package something as NPM package
***** creating and publishing private npm packages
      https://docs.npmjs.com/creating-and-publishing-private-packages
****** nevermind this is about using npm for private packages
***** Using a local folder
****** stackoverlow answer
       https://stackoverflow.com/a/14387210/2590119
#+begin_src json
  {
    {
      "name": "baz",
...
**** Doctorow on [[file:20210519152202-ransomware.org][ransomware]] email :ransomware:
    [[mu4e:msgid:08b81dbd-f265-7db5-2adb-7b6a00c39737@craphound.com][[Plura-list] A simple, incomplete ransomware defense; Community Health Services sued its way through the pandemic; Apple's complicity in Chinese state oppression; What Would Open Source Look Like If It Were Healthy?]]
***** all sorts of different ransomeware actors
      like state sponsored, idiots, etc
      makes me think of pirates in the old days, privateers etc
      should read into that more and think about how that might apply today
***** apparently you can install a russian keyboard to avoid ransomware lmao
      because russian hackers don't want to accidentally pick up russian targets
***** TODO install russian keyboards on all systems :life:
