...
#+ROAM_TAGS: "computer science" data functions "curriculum"
...
* Self-reference ( 7 lectures, 5-7 hours)
  :LOGBOOK:
  CLOCK: [2021-07-14 Wed 14:50]--[2021-07-14 Wed 15:15] =>  0:25
...
*** product true if list contains "UBC"
    ...
    (cond [(empty? los) false]
          [else
           (if (string=? (first los) "UBC")
               ...
               (fn-for-los (rest los)))]))
#+end_src
As you can see, contains a [[file:20201007205328-recursion.org][recursive]] call
** revising the recipes for lists
*** well formed self-reference
    In order to accommodate an arbitrary amount of information, and meet the
    requirement of arbitrary-sized data, A well formed self-reference has:
   ...
   - at least one self reference case
     ...
     #+begin_src racket
      ...
      ;; - (cons String ListOfString)
     #+end_src
*** writing check-expects (test) for recursive functions
    Best to do base case examples / tests first
